...
export default function App({navigation}) {
    ...
    return (
        <KeyboardAwareScrollView style={styles.container} resetScrollToCoords={{ x: 0, y: 0 }} contentContainerStyle={styles.align} scrollEnabled={false} keyboardShouldPersistTaps={'never'}>
            ...
            <View style={styles.loginFormContainer} keyboardShouldPersistTaps={'handled'}>
                ...
                <TextInput
                    ...
                    placeholder={'Email'}
                />
                <TouchableHighlight style={styles.loginBtn} onPress={() => reset()} activeOpacity={0.4}
                    underlayColor="#e7decc">
                    <Text style={styles.loginBtnText} >SEND EMAIL</Text>
                </TouchableHighlight>

                <Text style={styles.forgotPassword} onPress={() => navigate('Login')}>Go Back</Text>
            </View>
